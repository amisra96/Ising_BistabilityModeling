...
for j = 1:length(iter_vals)
    ...
    legend(Legends,'east')
    title(sprintf('Hysteresis Loop (# iterations = %g)',iter));xlabel('External Field H');ylabel('Mean Magnetization');
    saveas(gcf,sprintf('HysteresisLoop_iter-%g.jpg',iter));close all;
end